...
public:
  ...
  **/
	...
	/** Vérifie que chaque Animal est bien a sa place dans la Grille. Soulève une erreur si ce n'est pas le cas **/
	...
	**/
	...
	/** Deplace un Animal d'Id ident sur une case voisine libre. Renvoie true si le deplacement est possible, false sinon
	 * @param ident un Id
	 * @return un booléen
	**/
	...
	/** Fonction qui verifie la coherence des données, souleve une erreur si ce n'est pas le cas **/
